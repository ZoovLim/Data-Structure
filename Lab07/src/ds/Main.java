        ...
        while (scanner.hasNext()) {
            ...
            switch (getCommandNum(cmd)) {
                case UNION:
                    ...
                    System.out.println("Union " + Node1 + " and " + Node2);
                    break;
                ...
                case DIFFER:
                    ...
                    String answer = PPT.differ(Node1, Node2) ? "YES" : "NO";
                    System.out.println("DIFFER: " + answer);
                    break;

                case FIND:
                    Node1 = i_scanner.nextInt();
                    Integer root = PPT.find(Node1);
                    System.out.println(Node1 + "'s Root: " + root);
                    break;
                ...
                case S_ISLAND:
                    ...
                    int[] sz = sample_island.getIslandSize();
                ...
                case T_ISLAND:
                    ...
                    int[] sz2 = test_island.getIslandSize();
                    for (int i = sz2.length - 1; i >= 0; i--) {
